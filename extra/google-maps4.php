            ...
            var styles = [
                ...
                var contentString = '<?php mb_internal_encoding("UTF-8");?><a class="left cursor yazi-decoration" href="#">'+
                        '<div class="media cursor" style="width: 317px;">'+
                            '<img class="d-flex align-self-start cursor" src="<?=wp_get_attachment_image_url(get_post_thumbnail_id($iceriksehir -> icerik_detay_image_id),array(224,182,true));?>" alt="<?php wp_title(); ?>" style="width: 149px; height: 100px;">'+
                ...
                map = new google.maps.Map(document.getElementById('konum-maps4'), mapOptions);
